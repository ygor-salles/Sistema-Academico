...
query: CREATE TABLE "historics" ("id" uuid PRIMARY KEY NOT NULL, "semester" integer NOT NULL, "year" integer NOT NULL, "created_at" timestamp NOT NULL DEFAULT (now()), "student_id" uuid NOT NULL, CONSTRAINT "CHK_e2b430ed577c3b8e04ef0f53b4" CHECK (semester=1 OR semester=2), CONSTRAINT "FKStudent" FOREIGN KEY ("student_id") REFERENCES "students" ("id") ON DELETE CASCADE ON UPDATE CASCADE)
